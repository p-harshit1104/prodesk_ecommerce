      ...
      <nav className="flex justify-between items-center h-20 max-w-6xl mx-auto">
        ...
        <div className="flex items-center font-medium text-slate-100 mr-5 space-x-8 gap-10">
          <NavLink to="/" className={({isActive}) => isActive ? "text-white border-b-2 border-white pb-1" : "text-white"}>
           ...
           <NavLink to="/login" className={({isActive}) => isActive ? "text-white border-b-2 border-white pb-1" : "text-white"}>
            <p className="text-lg hover:scale-110 transition-transform duration-200">Login</p>
          </NavLink>
